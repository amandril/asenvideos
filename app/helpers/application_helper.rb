module ApplicationHelper
	...
	def video_embed(video_url)
  		...
  		if youtube_id
  			...
  			raw(%Q{<iframe src="https://player.vimeo.com/video/#{vimeo_id}?portrait=0&byline=0&title=0" width="560" height="315" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>})
  		else
